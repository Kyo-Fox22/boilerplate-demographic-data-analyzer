...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = round((higher_education & df['salary'] == '>50K').sum()/len(df) * 100, 2)
    lower_education_rich = round((lower_education & df['salary'] == '>50K').sum()/len(df) * 100, 2)
    ...
    highest_earning_country_percentage = df[df['salary'] == '>50K']['native-country'].value_counts()['United-States']/df[df['salary'] == '>50K']['native-country'].value_counts().sum() * 100
